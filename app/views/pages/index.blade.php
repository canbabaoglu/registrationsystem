...
@section('page-content')
	...
	<div class="jumbotron">
		...
		@else
			...
			<p>This is the registration system I've built with Laravel.  I've pushed on GitHub.  Now, thanks to Forge, whenever I push to GitHub the site is being Autodeployed. </p>
			<p>
